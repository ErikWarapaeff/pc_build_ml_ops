...
from agent_shema.build_assistants import Assistant, ToPriceValidationCheckerAssistant, ToPCBuildAssistant
...
class AgenticGraph:
    ...
    def add_price_validation_nodes_to_graph(self):
        ...
        self.builder.add_node("validate_price", Assistant(AGENT_RUNNABLES.price_validation_checker_runnable))
    ...
    def add_primary_assistant_nodes_to_graph(self):
        ...
        self.builder.add_node("primary_assistant", Assistant(AGENT_RUNNABLES.primary_assistant_runnable))
        self.builder.add_node(
            "primary_assistant_tools", create_tool_node_with_fallback(AGENT_RUNNABLES.primary_assistant_tools)
        )
