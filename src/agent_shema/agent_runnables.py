...
class AIAgentRunnables:
    ...
    def __init__(self) -> None:
        ...
        self.price_validation_checker_tools, self.price_validation_checker_runnable = self.build_price_validation_checker_runnable()
    ...
    def build_price_validation_checker_runnable(self):
        ...
        price_validation_checker_runnable = AGENT_PROMPTS.price_validation_checker_prompt | CFG.llm.bind_tools(
